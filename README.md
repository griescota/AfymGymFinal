...
Ejercicios adaptados según la capacidad física de cada usuario.

Seguimiento del progreso individual.

Acceso a recursos visuales y descriptivos que facilitan la comprensión de los ejercicios.
...
Educadores / Profesionales: Monitorear el rendimiento de los usuarios, ajustar planes de ejercicio y acceder a información detallada sobre cada usuario.
...
Inicio de sesión seguro: Acceso personalizado según el rol del usuario.

Pantalla de entrenamiento: Ejercicios con descripción, imagen, botones de “Realizado” y opción de escanear código QR.

Pantalla de progreso: Visualización de logros y estadísticas del usuario.
...
Pantalla de registro o login: Captura de datos de usuario.

Pantalla principal según rol: Acceso a recursos, ejercicios o seguimiento.

Ejercicios: Información visual y textual, con botones de acción.
